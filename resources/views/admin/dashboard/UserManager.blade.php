                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        <div class="flex-grow-1 overflow-hidden">
                                            <p class="text-uppercase fw-medium text-muted text-truncate mb-0"> Tài khoản
                                                admin
                                            </p>
                                        </div>
                                    ...
                                    <div class="d-flex align-items-end justify-content-between mt-4">
                                        <div>
                                            <h4 class="fs-22 fw-semibold ff-secondary mb-4"> <span class="counter-value"
                                                    data-target="{{ $total }}"></span> Manager</h4>
                            ...
                            <div class="card card-animate">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-end justify-content-between mt-4">
                                        <div>
                                            <h4 class="fs-22 fw-semibold ff-secondary mb-4"><span class="counter-value"
                                                    data-target="{{ $total2 }}"></span> Customer </h4>
                                            <a href="" class="text-decoration-underline">Xem Tất Cả</a>
                                        </div>
                                        <div class="avatar-sm flex-shrink-0">
                                ...
                                <div class="col-sm-auto">
                                    <div>
                                        <a href="#" class="btn btn-success add-btn" id="create-btn"><i
                                                class="ri-add-line align-bottom me-1"></i> Thêm Người Dùng</a>
                                        ...
                                        <div class="search-box ms-2">
                                            <form action="{{ route('admin.SearchUser') }}" method="GET">
                                                ...
                                                <input type="text" class="form-control search" name="searchUser"
                                                    placeholder="Tìm Kiếm Người Dùng..." id="search-input">
